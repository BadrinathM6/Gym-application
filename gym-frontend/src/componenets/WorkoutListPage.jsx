      ...
      {loading ? (
        ...
        <div className="page-container">
          ...
          <div className="headers">
            <div className="header-content">
              ...
              <p className="workout-info">
                9 mins • {exercises.length} Workouts
              </p>
            </div>
          ...
          <div className="workout-container">
            <div className="workout-header2">
              <p className="workout-summary">
                {totalCaloriesBurned.toFixed(2)} Calories • {exercises.length}{" "}
                Workouts
              </p>
            </div>
                ...
                <div className="icon-placeholder">
                  {exercise.exercise.animation_path.endsWith(".mp4") ? (
                    ...
                    />
                      ...
                      exercise.exercise.animation_path.endsWith(ext)
                    ) ? (
                    <img
                      src={exercise.exercise.animation_path}
          ...
          <div className="workout-button">
            <button className="start-buttons" onClick={handleStartWorkout}>
              START WORKOUT
            </button>
          </div>
